...
function PatientRegistry({ onPatient, onChanged }: { onPatient: (id: string) => void; onChanged: () => void }) {
  ...
  return <Panel title="Patient registry" subtitle="Search and manage canonical clinical patient records." action={<button onClick={() => setShowForm(true)} className="primary"><PlusIcon size={18} weight="bold" />Register patient</button>}>
